...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--moe-streaming"},
        {"--no-moe-streaming"},
        string_format("whether to do expert-slice streaming with compatible MoE models (default: %s)", params.use_moe_streaming ? "enabled" : "disabled"),
        [](common_params & params, bool value) {
            params.use_moe_streaming = value;
        }
